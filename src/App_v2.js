...
function App() {
    React.useEffect(() => {
        ...
        const experience_section = document.querySelector(".experience");
        ...
        observer.observe(experience_section);
    ...
    const projects = [
        ...
        {
            name: "MyLeetCode",
            description: `A simple version of LeetCode which allows users to <b>solve problem</b> on the page and
            <b>submit solutions</b>. GenAI tool is also enabled in the application.`,
            link: "https://github.com/JIAHONG-PENG/myLeetcode/tree/main#",
            tech_stack: "Next.js"
        },
        {
            ...
            description: `- Submitter receives input from user and sends to database on
                  ...
                  record received`,
            tech_stack: "Vue.js, AWS (Lambda, DynamoDB)"
        },
    ];
    ...
    const expreience =[
        {
            ...
            tech_stack: "PHP (Laravel), React.js, Vue.js, MySQL, AWS, Docker, Nginx, Bitbucket, Git"
        },
        {
            name: "S1T2 Pty Ltd",
            ...
            position: "Full Stack Developer",
            tech_stack: "Vue.js, WordPress APIs, MySQL, AWS, Bitbucket, Git"
        }
    ];
    ...
    const experience_items = expreience.map(({name, description, link, location, date, position, tech_stack}, index) => {
        return (
            <li
    ...
    return (
		...
		l0.26-0.112l109.086-46.639L369.477,176.444z"
                        ...
                        <div className="col-md-3 col-sm-6 col-6">
                            <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="php">
                                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                        ...
                        <div className="col-md-3 col-sm-6 col-6">
                            <svg fill="#000000" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" className="mysql">
                            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                            <g id="SVGRepo_iconCarrier"> 
                                <title>mysql</title> 
                        ...
                        <div className="col-md-3 col-sm-6 col-6">
                            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" className="aws">
                                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                <g id="SVGRepo_iconCarrier"> 
            ...
            <div className="container-sm experience mt-2">
                ...
                <ul className="flex-display mb-0">{experience_items}</ul>
            </div>
                    ...
                    <div className="row">
                        <div className="col-md-5 description">
                            ...
                            <p>
                                ...
                                I'm also a big fan of fitness 🏋️‍♂️.
                            </p>

                            <div>
                                <u style={{ fontSize: "20px" }}>Education:</u>{" "}
                                <br />
                                Bachelor of Computing, majoring in computer
                                science (usyd) <br />
